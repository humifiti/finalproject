...
export const getListOrdered = createAsyncThunk(
  'ListOrderedSlice',
  async (payload: any) => {
...
const listOrderedSlice = createSlice({
  name: 'ListOrderedSlice',
  initialState: initState,
  reducers: {},

  extraReducers: builder => {
    builder.addCase(getListOrdered.pending, (state, action) => {
    ...
    builder.addCase(getListOrdered.fulfilled, (state, action) => {
    ...
    builder.addCase(getListOrdered.rejected, state => {
...
export const {} = listOrderedSlice.actions
export default listOrderedSlice.reducer
